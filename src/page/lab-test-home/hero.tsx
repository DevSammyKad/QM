    ...
    <div className="bg-green-gradient max-md:bg-none  w-full pt-20 pb-10 max-md:pt-7 max-md:pb-1">
      <div className="flex items-center justify-center  flex-col w-1/2  max-xl:w-2/3 max-md:w-[90%] mx-auto">
        <h1 className="text-5xl max-lg:text-4xl font-bold text-center leading-[62px] max-md:hidden">
          Search for Tests/Packages/Labs{" "}
        </h1>
        ...
        <div className="w-full flex items-center justify-end pt-2 text-xs  gap-3">
          ...
          <div>
            <UploadPresButton>
              <p className="flex items-center text-secondary-500 gap-1">
                Upload now
                <ArrowIcon
      ...
      <SiteLayout className="w-2/3 mx-auto max-xl:w-full grid items-center grid-cols-3 gap-5 max-xl:gap-4 max-lg:grid-cols-2  px-10 max-xl:px-5 max-md:hidden">
        <ColorfulButton
        ...
        <ColorfulButton
          ...
          titleDesc="Call us to book tests"
          startIcon={<ImgTab src="/phonecall.png " />}
          endIcon={<ArrowIcon className="-rotate-90" width={15} />}
          bgColor="#E5F3FF"
        >
          +91 0987654321{" "}
        ...
        <ColorfulButton
          link={"https://wa.me/+910987654321"}
          titleDesc="Whatsapp to book tests"
          startIcon={<ImgTab src="/whatsapp.png " />}
          endIcon={<ArrowIcon className="-rotate-90" width={15} />}
          bgColor="#E5E9FF"
        >
          +91 0987654321{" "}
